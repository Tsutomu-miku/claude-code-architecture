...
export default function TechStack() {
  ...
  return (
    <section id="tech" className="section" style={{ background: '#f8fafc' }}>
      <span style={{
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderColor: isExpanded ? item.color : '#e2e8f0',
      }}
      layout
          ...
          >
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ color: item.color }}>&#9670;</span> 关键特性
              </div>
              <ul style={{
                listStyle: 'none',
                padding: 0,
              ...
              <div style={{
                ...
                <span style={{ color: '#7c3aed' }}>&#9670;</span> 相关文件
              </div>
              <div>
                {item.files.map((f, fi) => (
                  <span key={fi} style={{
